...
function assign_item(item_id){
	var item_data={texture:spr_empty,item_id:"empty",name:"empty",tags:[],ground_sound:"groundsoft",calories:0,particle_texture:spr_empty,held_texture:spr_empty,special_data:{}}
