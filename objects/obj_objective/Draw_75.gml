...
var mouse_in=draw_money_box_gui(coin_offset_x,coin_offset_y,coin_sprite,3.6)//draw_box_data_icon_and_value_gui(string(global.coins),coin_sprite,coin_offset_x,coin_offset_y,3.6,2,spr_textbox,0.08)
if mouse_in
{
