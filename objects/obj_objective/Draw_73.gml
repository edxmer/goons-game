...
draw_text_transformed(x+text_offset_x+shadow_offset, y+text_offset_y+shadow_offset,title_text, text_scale, text_scale, text_rotation)
draw_set_color(c_white)
draw_text_transformed(x+text_offset_x, y+text_offset_y, title_text, text_scale, text_scale, text_rotation)
