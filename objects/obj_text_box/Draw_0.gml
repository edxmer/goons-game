...
draw_sprite_ext(spr_goon_speech_box, 0, _x, _y, 2, 2, 0, c_white, 1)
...
draw_text_ext_transformed(_x + _txt_offset + padding*0.5, _y + _txt_offset + padding, text_current, 20, (box_width - padding*2)/scale_text, scale_text, scale_text, 0)
