...
txtg("Scroll to zoom", "Tutorial"),
txtg("Bring mouse to the sides of screen to move camera, or use WASD", "Tutorial"),
txtg("Hold down mouse button to select multiple goons", "Tutorial"),
txtg("Press on item to go and pick up item", "Tutorial"),
